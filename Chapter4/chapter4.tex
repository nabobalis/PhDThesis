...
\section{Introduction}
    ...
    One such structure is a pore; a magnetic concentration with a diameter that ranges from $0.5$ to $6$ Mm with magnetic fields of 1-3 kG that typically last for less than a day \citep{1970SoPh...13...85S}.
    pores are highly dynamic objects due to the constant buffeting from the surrounding granulation in the photosphere.
    A collection of flows and oscillations have been observed within and around pores \citep{1999SoPh..187..389B,2002A&A...383..275H,2002A&A...395..249R,doretalb,SAO,Dorotovic2014,freij2014,jess2015multiwavelength,2015A&A...579A..73M}.
    The major apparent difference between a sunspot and a pore is the lack of a penumbra which is a region of strong and often very inclined magnetic field that surrounds the umbra. 
    ...
    \cite{doretala2008} observed the evolution of a pore's area for 11 hours in the sunspot group NOAA 7519 \citep[see][]{1997A&A...328..682S,doretalb}.
	...
	\cite{0004-637X-806-1-132} observed a pore within Active Region NOAA 11683, using high-resolution scans of multiple heights of the solar atmosphere using ROSA and the Interferometric Bidimensional Spectrometer (IBIS) on the DST.
    ...
    In this article, we exploit phase relations between the area and intensity of two pores in order to identify the wave mode of the observed oscillations.
...
\label{DnA}
    ...
    \begin{figure}
        ...
        \caption{
		         The left column displays the pore observed by the DOT while the right column is the pore observed by the DST/ROSA. 	
	        	 The pores at the start of the observation sequence (\textit{Upper panels}).
    ...
    The first dataset was acquired using the Dutch Open Telescope (DOT) \citep{rutten}, located on La Palma in the Canary Islands. 
    ...
    The top row of Figure \ref{overview} shows the pores at the start of the observation sequence, by DOT and ROSA, respectively. 
    Furthermore, the output from the area analysis is shown in the bottom row for both pores.
...
\label{Wave}
    ...
    Assume that a pore is modelled adequately by a cylindrical waveguide with a straight background magnetic field, i.e., $\textbf{B}_0=B_0\hat{\textbf{z}}$.
    ...
    However, the influence of gravity may be important for wave propagation in pores, especially at the photospheric level where the predicted scale height is comparable to the wavelengths of observed oscillations.
...
\label{res}
    ...
    This is important because pores and sunspots share a number of common features.
    ...
    The percentage change in pore area, hence magnetic field, is found to be $$\frac{A_1}{A_0} = \frac{b_1}{B_0} \rightarrow 4-7\%.$$
   	For another pore, the percentage change was found to be similar at 6\% \citep{0004-637X-806-1-132}.
    ...
    This needs to be investigated in the future, as the author is unaware of which MHD mode would cause this behaviour, however, it has been suggested that is due to noise within the dataset \citep{2015A&A...579A..73M}.
    ...
    \begin{table*}
        ...
        \end{tabular}
        \caption{
            The periods of oscillations as well as the harmonic ratios for the DOT and ROSA pore respectively.
	...
	Table \ref{harm_table} details the periods that have been found from the two pore datasets used within this article.
    ...
    The pores were observed before the launch of NASA's Solar Dynamics Observatory (SDO),
	...
	Another potential source is from mode conversion that will occur at the lower region of the photosphere within sunspots and pores.
	...
	Furthermore, sunspot umbras are depressed in height and it would likely be the same for pores.
    ...
    The data available for pores does not cover higher levels of the solar atmosphere such as the chromosphere or the transition region.
    The data presented here only represents a slice of the flux tube near the photosphere.
    Future work is needed to acquire simultaneous observations of pores in several wavelengths in order to sample the solar atmosphere at different heights.
    ...
    By studying the area and intensity perturbations of pores, it enables the investigation of the phase relations between these two quantities with the use of wavelets and EMD.

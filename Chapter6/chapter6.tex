...
\section{Overview of the thesis}
    ...
    These equations calculate several properties (radial, radial velocity and magnetic field perturbations) of the detected waves, as well as information on the background properties of the observed magnetic flux tubes.
...
\section{Summary of results}
    ...
    It should be noted that this study can be expanded upon which will be discussed in Chapter 6, Section 3. 
    ...
    Table \ref{harm_table} lists the period ratios of the observed oscillations for the two magnetic pores and other period ratios are used from \cite{Dorotovic2014} (Chapter 3).

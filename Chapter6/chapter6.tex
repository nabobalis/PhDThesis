...
\section{Future work and questions}
	...
	To begin, in Chapter 2 the signal analysis methods used with this thesis were described.
	These methods were used to analyse signals to measure the period and phase of a signal and they were used successful in order to achieve the overall goals for each chapter.
	However, the field of signal analysis is ever evolving.

...
\section{Summary of results}
    ...
    Finally, the phase relations are used to identify the various MHD wave modes and these are listed in Table \ref{tab:phase}.
    ...
    The phase difference between the cross-sectional area and total intensity was calculated to be close to 0$^\circ$, from both the wavelet and EMD analyses.
...
\section{Future work and questions}
    ...
    For example, \ion{Fe}{I} 630.26 nm, \ion{Na}{D} 589.70 nm, and \ion{Ca}{II} 854.16 nm filters sample the lower photosphere ($\sim$50 km), mid-photosphere ($\sim$450 km) and mid-chromosphere ($\sim$1000 km), respectively.
	...
	This can be coupled with full-Stokes polarimetric measurements of \ion{Ca}{II} $854.2$ nm spectral line and \ion{Fe}{I} $630.2$ nm which would allow the computation of the background density and temperature of the photosphere and chromosphere using the NLTE Stokes Synthesis/Inversion Code

...
\subsection{MHD equations}
    ...
    There is assumed to be no background flow and that all perturbations are much smaller than the background value (\textit{e.g.,} $\mathrm{B}_0 \gg \mathrm{B}_1$).      
    This leads to the linearised ideal MHD equations (see Appendix 1 for a derivation),
    \begin{align}                                                         

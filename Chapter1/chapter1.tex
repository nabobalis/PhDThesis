...
\subsection{MHD waves in cylindrical flux tubes}
	...
	Finally, the previously derived theory \citep{Moreels2013,Moreels2013b,2015A&A...579A..73M,jess2015multiwavelength} gives an insight into the observational signatures that MHD sausage waves will exhibit within a magnetic waveguide.
    ...
    From \cite{Moreels2013}
	From all of these sources, blah blah blah.

	A discussion of what one would expect to see based on theory in terms of amplitudes of intensity and area oscillations would be good.
	What are we looking for and do we even have a chance to see it in the data?

...
\subsubsection{Active regions}
	...
	Furthermore, $\delta$-type sunspots have an umbra that has an opposite polarity it penumbra and large solar flares are common here as the magnetic gradients are high and the magnetic field is highly complex.

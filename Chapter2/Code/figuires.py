...
# Wavelet
wave,scales,sig95,idx,t1,coi,period,power = wavel(data,dt)
...
ax2.axis((0.0, 0.49115090963202424, 0.0, 265875.41972367489))
...
## Sunspot
#sun_data = readsav('/data/Data/Reduced_data_blue.sav')['blue_spk_cor']
#sun_dt = 6.8
#sun_pixel_arc = 0.097
...
#
## Pore
#pore_data = fits.getdata('/data/Data/gband_pore.fits')

...
start = parse_time('2015/04/17T22:58:00')
...
sorted_wavelengths = [211, 171, 304, 6173.0, 193, 131, 94, 335, 1700] #  u.AA
...
# Display the Figure.
#plt.show()
plt.savefig('/home/nabobalis/GitRepos/PhDThesis/Chapter2/Figs/SDO.pdf',dpi=300,bbox_inches='tight')
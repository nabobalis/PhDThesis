...
\subsection{Empirical Mode Decomposition (EMD)}
    ...
    There are two comments to be made here about the algorithm.
    The first is about the stopping criterion, as their are two commonly used definitions.
...
\section{Area analysis}
    ...
    Second, the magnetic pore observed with ROSA will be investigated.
    ...
    Overall, the conclusion for this analysis is that the sigma multiplier will not vary the result as long as the value of sigma multiplier is sane.

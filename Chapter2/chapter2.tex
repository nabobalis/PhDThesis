...
\subsection{Other ground telescopes}
    ...
    The tower itself moves, unlike the SST where it is just the telescope mount, it is on a ring of liquid mercury and it allows it to rotate to track the Sun throughout the day. 
...
\section{Signal analysis}
	...
	Once the process of data acquisition is finished and the reduction is undertaken using methods that are specific for that telescope or instrument, analysis of the data can begin.

...
\subsection{Other ground telescopes}
	...
	Data from three other ground-based telescopes is used.
...
\section{Signal analysis}
	...
	The analysis undertaken within this thesis is focused on measuring the properties of waves in several sunspots and pores and later a single dataset studying RPWs.
...
\subsection{Wavelet transform}
	...
	For example, the wavelet chosen is the Morlet Wavelet.
	It is defined as,
	\begin{equation}
...
\section{Area analysis}
    ...
    \begin{sidewaysfigure}
        ...
        \caption{
                ...
                The pore investigated here is the larger one in the middle.
                }
    ...
    \begin{sidewaysfigure}
        ...
        \caption{
                ...
                The contour colours of blue, green, purple and orange correspond to 3, 3.5, 4 and 4.5$\sigma$ and 2, 2.5, 3 and 3.5$\sigma$ for the sunspot and pore respectively.
    ...
    First, the sunspot observed with IBIS will be investigated.
    ...
    Second, the pore observed with ROSA will be investigated.
    The overall picture is quite different and the main reason for this is the lack of a penumbra.
    While there was a plateau that separated the penumbra and umbra for the sunspot, this is missing for the pore and the sigma multiplier is harder to directly choose.
    ...
    This tail corresponds to the pixel values that correspond to the pore.
    For a pore, this tail can be used to pick a sigma multiplier since it tails off to much lower values than the quiet Sun histogram.
    ...
    Figure \ref{fig:sunspot_wavelet} and \ref{fig:pore_wavelet} show the wavelet transform of the signals that correspond to the smallest and largest sigma multipliers used for the sunspot (3, blue and 4.5, orange) and pore (2, blue and 3.5, orange).
    ...
    \begin{sidewaysfigure}
        ...
        \caption{
            Same as Figure \ref{fig:sunspot_wavelet} but for the pore observed with DST/ROSA.
    ...
    \begin{sidewaysfigure}
     	...
     	\caption{
	             		Same as Figure \ref{fig:phase_sunspot} but for the pore observed with DST/ROSA.
